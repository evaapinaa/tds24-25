...
public class VentanaBusqueda extends JDialog {
    ...
    public VentanaBusqueda() {
    	setIconImage(Toolkit.getDefaultToolkit().getImage(VentanaBusqueda.class.getResource("/umu/tds/apps/resources/lupaGrande.png")));
        setResizable(false);
        setTitle("Búsqueda");
        ...
        panelBuscar.setBorder(new TitledBorder(new LineBorder(new Color(47, 79, 79), 2, true), "Buscar", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
        ...
        JPanel panel_1 = new VisualUtils.JPanelGradient(new Color(100, 190, 165), new Color(150, 210, 230));
        panel_1.setBorder(new LineBorder(new Color(0, 0, 0)));
        //panel_1.setBackground(new Color(0, 139, 139));
        panel_1.setFont(new Font("Arial", Font.PLAIN, 11));
